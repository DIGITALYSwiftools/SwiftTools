...
export default function Footer() {
  return (
    <footer className="w-full pt-8 px-6 bg-gradient-to-r from-[#8ee3f9] via-[#fbc7d4] to-[#d7f5d9] rounded-lg flex items-end justify-between max-w-5xl mx-auto mb-10">
      ...
      <div className="max-w-md">
        ...
        <button className="bg-black text-white text-sm font-semibold py-2 px-4 rounded hover:bg-gray-800 transition mb-6">
